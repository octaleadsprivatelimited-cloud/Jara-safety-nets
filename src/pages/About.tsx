  ...
  return (
    <div className="min-h-screen py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Hero Section */}
        <div className="bg-gradient-to-r from-orange-600 to-orange-700 text-white rounded-2xl p-8 md:p-12 mb-16 relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-orange-600/90 to-orange-700/90"></div>
          <div className="absolute inset-0 bg-mesh opacity-20"></div>
          <FloatingElements count={6} colors={['#ffffff', '#FF6B35', '#FFD700', '#3B82F6', '#ef4444', '#8b5cf6']} size="medium" />
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <ScrollAnimation animation="fadeInLeft" delay={200}>
              <div>
                ...
                <p className="text-xl text-yellow-100 mb-8 animate-fade-in-up">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <ScrollAnimation animation="scaleIn" delay={400}>
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 text-center hover:bg-white/20 transition-all duration-300 hover:scale-105">
                      ...
                      <p className="text-yellow-100 animate-fade-in-up">Years Experience</p>
                    </div>
                  </ScrollAnimation>
                  <ScrollAnimation animation="scaleIn" delay={500}>
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 text-center hover:bg-white/20 transition-all duration-300 hover:scale-105">
                      <h3 className="text-2xl font-bold mb-2 animate-text-reveal">500+</h3>
                      <p className="text-yellow-100 animate-fade-in-up">Projects Completed</p>
                    </div>
                  </ScrollAnimation>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <ScrollAnimation animation="fadeInUp" delay={300}>
              <div className="text-center p-6 bg-orange-50 rounded-lg hover:shadow-lg transition-all duration-300 hover:scale-105 hover:-translate-y-2">
                <div className="w-16 h-16 bg-orange-600 rounded-full flex items-center justify-center mx-auto mb-4 hover:scale-110 transition-transform duration-300 animate-pulse-glow">
            ...
            <ScrollAnimation animation="fadeInUp" delay={400}>
              <div className="text-center p-6 bg-yellow-50 rounded-lg hover:shadow-lg transition-all duration-300 hover:scale-105 hover:-translate-y-2">
                <div className="w-16 h-16 bg-yellow-500 rounded-full flex items-center justify-center mx-auto mb-4 hover:scale-110 transition-transform duration-300 animate-rotate3d">
            ...
            <ScrollAnimation animation="fadeInUp" delay={500}>
              <div className="text-center p-6 bg-blue-50 rounded-lg hover:shadow-lg transition-all duration-300 hover:scale-105 hover:-translate-y-2">
                <div className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-4 hover:scale-110 transition-transform duration-300 animate-morphing">
        ...
        {/* Contact Information */}
        <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-2xl p-8 relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-orange-50/30 to-yellow-50/30"></div>
          <div className="absolute inset-0 bg-mesh opacity-10"></div>
          <FloatingElements count={4} colors={['#FF6B35', '#FFD700', '#3B82F6', '#ef4444']} size="small" />
          <ScrollAnimation animation="fadeInUp" delay={200}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <ScrollAnimation animation="fadeInUp" delay={300}>
              <div className="text-center hover:scale-105 transition-all duration-300 hover:-translate-y-2">
                <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4 hover:scale-110 transition-transform duration-300 animate-pulse-glow">
            ...
            <ScrollAnimation animation="fadeInUp" delay={400}>
              <div className="text-center hover:scale-105 transition-all duration-300 hover:-translate-y-2">
                <div className="w-16 h-16 bg-yellow-100 rounded-full flex items-center justify-center mx-auto mb-4 hover:scale-110 transition-transform duration-300 animate-rotate3d">
            ...
            <ScrollAnimation animation="fadeInUp" delay={500}>
              <div className="text-center hover:scale-105 transition-all duration-300 hover:-translate-y-2">
                <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4 hover:scale-110 transition-transform duration-300 animate-morphing">
        ...
        <div className="text-center mt-16 relative overflow-hidden">
          ...
          <FloatingElements count={3} colors={['#FF6B35', '#FFD700', '#3B82F6']} size="small" />
          <ParallaxElement speed={0.3} direction="up">
            <div className="absolute top-10 left-10 w-16 h-16 bg-orange-600/10 rounded-full animate-pulse-glow"></div>
          </ParallaxElement>
          <ParallaxElement speed={0.4} direction="down">
            <div className="absolute bottom-10 right-10 w-12 h-12 bg-yellow-500/10 rounded-full animate-wave"></div>
          </ParallaxElement>
          <div className="relative">
            <ScrollAnimation animation="fadeInUp" delay={200}>
