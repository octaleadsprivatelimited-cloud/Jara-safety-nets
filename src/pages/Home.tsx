        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollAnimation animation="fadeInUp" delay={200}>
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 justify-center items-center max-w-2xl mx-auto">
              <a
                href="tel:+918074616049"
                className="group w-full sm:w-auto bg-white text-blue-600 px-6 py-3 rounded-xl font-semibold hover:bg-gray-100 transition-all duration-300 flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
                <Phone className="mr-2 w-4 h-4 sm:mr-2 sm:w-4 sm:h-4 text-blue-600" />
              ...
              >
                <div className="flex items-center">
                  <svg className="mr-1 w-3 h-3 sm:mr-2 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Link
                to="/contact"
                className="group w-full sm:w-auto bg-gradient-to-r from-green-500 to-green-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-green-600 hover:to-green-700 transition-all duration-300 flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
                <Shield className="mr-2 w-4 h-4 sm:mr-2 sm:w-4 sm:h-4" />
